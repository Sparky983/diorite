...
public class WorldBorderWarningReachPacket implements ClientBoundPacket {
    ...
    public WorldBorderWarningReachPacket(final @NotNull MinecraftInputStream inputStream) {
