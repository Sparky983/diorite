...
public class ChangeGameStatePacket implements ClientBoundPacket {
    ...
    public ChangeGameStatePacket(final @NotNull StreamIn inputStream) {

        Preconditions.requireNotNull(inputStream, "inputStream");

        this.reason = inputStream.readUnsignedByteEnum(Reason.class);
    ...
    public void write(final @NotNull StreamOut outputStream) {
        ...
        outputStream.writeUnsignedByteEnum(reason)
                .writeFloat(value);
    }
