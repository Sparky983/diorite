...
public class InitializeWorldBorderPacket implements ClientBoundPacket {
    ...
    public InitializeWorldBorderPacket(final @NotNull MinecraftInputStream inputStream) {
