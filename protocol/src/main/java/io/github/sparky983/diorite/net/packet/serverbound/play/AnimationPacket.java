...
public class AnimationPacket implements ServerBoundPacket {

    private final Hand hand;

    @Contract(pure = true)
    public AnimationPacket(final @NotNull Hand hand) {
    ...
    public AnimationPacket(final @NotNull MinecraftInputStream inputStream) {
    ...
    public int getId() {
        ...
        return ServerBoundPacketId.Play.ANIMATION;
    }
